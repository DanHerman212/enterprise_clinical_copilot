...
Usage:
    python mlops/evaluation/compute_hospital_baseline.py
...
# Ensure mlops is on sys.path for src imports.
_PROJECT_ROOT = Path(__file__).resolve().parent.parent
if str(_PROJECT_ROOT) not in sys.path:
    sys.path.insert(0, str(_PROJECT_ROOT))

from mlops.data.bigquery import run_query
from mlops.data.config import PROJECT_ID, FULL_TABLE_REF, LABEL_COLUMN
