...
Usage (from repo root):
    # Deploy
    .venv/bin/python mlops/serving/deploy_endpoint.py

    # Teardown everything (endpoint, keeps models)
    .venv/bin/python mlops/serving/deploy_endpoint.py --teardown

    # Teardown including registered models
    .venv/bin/python mlops/serving/deploy_endpoint.py --teardown --include-models
