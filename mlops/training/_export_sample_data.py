...
import numpy as np
import random
df = pd.read_parquet('/Users/danherman/Desktop/enterprise_clinical_copilot/mlops/training/sample_data.parquet')
...
df.to_parquet('/Users/danherman/Desktop/enterprise_clinical_copilot/mlops/training/sample_data.parquet')
