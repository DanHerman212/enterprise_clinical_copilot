...
def fairness_audit(
    ...
    from mlops.training.components.fairness_audit import run_fairness_audit
    from mlops.training.components._experiment import companion_run, safe_log_metrics
