...
def train_final(
    ...
    from mlops.training.components.train_final import _build_training_curve_html, run_train_final
    from mlops.training.components._experiment import companion_run
