...
Usage (from repo root):
    .venv/bin/python mlops/scripts/smoke_test.py [hadm_id]
    .venv/bin/python mlops/scripts/smoke_test.py 20924467 --write-fixture
...
def _write_fixture(
    ...
    fixture["generated_by"] = "mlops/scripts/smoke_test.py --write-fixture"
