...
Rebuild with:
    .venv/bin/python mlops/serving/deploy_cpr.py             # endpoint
    .venv/bin/python scripts/agent/deploy_index.py   # vector
...
Usage (from repo root):
    .venv/bin/python scripts/agent/teardown.py --dry-run
    .venv/bin/python scripts/agent/teardown.py
    .venv/bin/python scripts/agent/teardown.py --yes
    .venv/bin/python scripts/agent/teardown.py --only endpoint
    .venv/bin/python scripts/agent/teardown.py --only vector-index
"""
...
def main() -> None:
    ...
    if not args.dry_run and not args.yes:
        ...
        if do_endpoint:
            print("Rebuild endpoint: .venv/bin/python mlops/serving/deploy_cpr.py")
        if do_vector:
            print("Rebuild vector:   .venv/bin/python "
                  "scripts/agent/deploy_index.py")
        print()
